...
export function MenuItem({ name, icon, href, dropdownItems, isActive, comingSoon }: MenuItemProps) {
            ...
            {dropdownItems?.length ? (
                <>
                    <div
                        ...
                        {isChildrenActive && <motion.span className="absolute bottom-0 left-0 right-0 h-full w-full rounded-xl shadow-large" layoutId="menu-item-active-indicator" />}
                    </div>
                ...
                <ActiveLink
                    ...
                    className={cn("relative flex h-10 items-center whitespace-nowrap rounded-xl px-4 text-sm text-gray-500  transition-all hover:text-white xl:text-base 2xl:h-12 3xl:text-lg")}
                    ...
                    {comingSoon && href !== pathname && <span className="relative z-[2] mx-2 rounded-full bg-gray-800 px-2 py-0.5 text-red-700">Coming Soon</span>}
                    {href === pathname && <motion.span className="absolute bottom-0 left-0 right-0 h-full w-full rounded-xl shadow-large" layoutId="menu-item-active-indicator" />}
                </ActiveLink>
            )}
        </div>
    );
