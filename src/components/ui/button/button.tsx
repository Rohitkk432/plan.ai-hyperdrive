...
const colors: Record<ColorNames, string[]> = {
    ...
    gray: ["text-gray-400", "bg-gray-900", "border-gray-100"],
    success: ["text-new-green", "bg-new-green", "border-new-green", "hover:!shadow-[0_0_15px_1px] hover:!shadow-primary-green2"],
    info: ["text-new-blue", "bg-new-blue", "border-new-blue", "hover:!shadow-[0_0_15px_1px] hover:!shadow-primary"],
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        switch (variant) {
            ...
            case "transparent":
                buttonColorClassNames = `${colorClassNames[0]} ${disabled || isLoading ? "" : "hover:bg-gray-800 focus:bg-gray-800"} `;
                buttonDripColor = "rgba(0, 0, 0, 0.1)";
                break;
        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    disabled || isLoading || variant === "transparent" ? "" : "hover:-translate-y-0.5 hover:shadow-md focus:-translate-y-0.5 focus:shadow-md focus:outline-none",
                    isLoading && "pointer-events-auto cursor-default focus:outline-none",
                    fullWidth && "w-full",
                    color === "white" || color === "gray" ? "text-white" : variants[variant],
                    shapes[shape],
