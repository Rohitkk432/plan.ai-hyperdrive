export const JiraWhiteIcon: React.FC<React.SVGAttributes<{}>> = (props) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="currentColor" strokeWidth="1" stroke="currentColor" className="h-3.5 w-3.5" {...props}>
