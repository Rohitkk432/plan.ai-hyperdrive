    ...
    return (
        <div className="flex w-screen justify-between items-center flex-col-reverse gap-14 sm:gap-0 sm:items-start sm:flex-row border-t-2 border-primary bg-[#060606] py-16 px-12">
            ...
            <div className="flex flex-col items-center sm:items-end gap-8">
                <div className="flex gap-3 xs:gap-8 whitespace-pre text-sm md:text-base xl:text-lg 3xl:text-xl">
                ...
                <div className="flex gap-8 xs:gap-10">
                    ...
                    <AnchorLink href={"https://discord.gg/kMDuqbccey"} target="_blank" className="flex h-8 w-10 cursor-pointer items-center justify-center">
                        <DiscordIcon />
                    </AnchorLink>
                    <AnchorLink href={"https://github.com/defi-os"} target="_blank" className="flex h-8 w-10 cursor-pointer items-center justify-center">
                        <GithubIcon />
                    </AnchorLink>
                    <AnchorLink href={"#"} className="flex h-8 w-10 cursor-pointer items-center justify-center">
                        <YoutubeIcon />
                    </AnchorLink>
                    <AnchorLink href={"#"} className="flex h-8 w-10 cursor-pointer items-center justify-center">
                        <MediumIcon />
