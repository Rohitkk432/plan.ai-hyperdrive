    ...
    return (
        <div
            ...
            <div className="absolute z-[20] flex cursor-pointer items-center justify-start gap-3 whitespace-nowrap rounded-full bg-[#0a0a0a] px-[12px] py-2 text-xs transition-all duration-300 xl:px-[16px] xl:py-2.5 xl:text-sm 3xl:px-[18px] 3xl:py-3 3xl:text-base">
                <GithubOutlineIcon />
                <div className="flex w-10 items-center gap-5 overflow-hidden transition-all duration-300 group-hover:w-20 xl:w-11 xl:gap-4 xl:group-hover:w-24 3xl:w-12 3xl:gap-3.5 3xl:group-hover:w-28">
                    <div className="transition-all duration-300 group-hover:-translate-x-20">Sign in</div>
                    <div className="transition-all duration-300 group-hover:-translate-x-20">with Github</div>
                </div>
            ...
            <div className="absolute z-[10] flex items-center justify-start gap-3 whitespace-nowrap rounded-full bg-gradient-to-r from-[#FE9A3E] to-[#6BAE63] px-[12px] py-2 text-xs blur-[16px] transition-all duration-300 xl:px-[16px] xl:py-2.5 xl:text-sm 3xl:px-[18px] 3xl:py-3 3xl:text-base">
                <GithubOutlineIcon />
                <div className="flex w-10 items-center gap-5 overflow-hidden transition-all duration-300 group-hover:w-20 xl:w-11 xl:gap-4 xl:group-hover:w-24 3xl:w-16 3xl:gap-3.5 3xl:group-hover:w-28">
                    <div className="transition-all duration-300 group-hover:-translate-x-20">Sign in</div>
                    <div className="transition-all duration-300 group-hover:-translate-x-20">with Github</div>
                </div>
                <ArrowRightIcon className="h-3.5 xl:h-4 3xl:h-5" />
