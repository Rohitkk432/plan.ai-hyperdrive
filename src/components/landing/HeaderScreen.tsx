    ...
    return (
        <div className="relative flex h-[907px] w-[1368.50px] mt-20 items-start scale-[0.4] xs:scale-[0.5] sm-scale-[0.6] md:scale-[0.75] lg:scale-[0.85] xl:scale-100 justify-center">
            <div className="absolute h-[800px] w-[1000px] opacity-75 blur-[100px]">
                ...
                <div className="absolute left-[-50px] top-[260px] h-[530px] w-[530px] rounded-full bg-[#F5E468] blur-[100px]" />
                <div className="absolute left-[-40px] top-[65px] h-[830px] w-[680px] rounded-full bg-[#FE9A3E] blur-[100px]" />
            </div>
            <div className="absolute left-0 top-[18px] h-[775.50px] w-[1368.50px]">
                ...
                <div className="absolute right-[-10px] top-[1.5px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="984" height="119" viewBox="0 0 984 119" fill="none">
                        <g opacity="0.1">
                            <path d="M1.5 2L64.5 89M155 1L193.5 87M433.5 1L406 87M586 2L524 87M785 2L685 86.5M982.5 20.5L817.5 117.5" stroke="white" strokeWidth="2" />
                        </g>
                    </svg>
                </div>
                <div className="absolute left-[-10px] bottom-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="604" height="142" viewBox="0 0 604 142" fill="none">
                        <g opacity="0.1">
                            <path d="M187.5 2.5L1 106M357 2.5L192 140.5M487.5 1.5L386.5 140.5M603 1.5L542.5 139" stroke="white" strokeWidth="2" />
                        </g>
                    </svg>
                </div>
                <div className="absolute right-[-10px] bottom-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="596" height="142" viewBox="0 0 596 142" fill="none">
                        <g opacity="0.1">
                            <path d="M393 1L594.5 118.5M231.5 1L395.5 138M99.5 2L199.5 140.5M1 1.5L47 141.5" stroke="white" strokeWidth="2" />
                        </g>
                    </svg>
                </div>
